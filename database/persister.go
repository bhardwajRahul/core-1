...
type Persister interface {
	...
	// ChangeUserEmail changes a user's email and related membership/account email records
	ChangeUserEmail(dbName, userID, accountID, oldEmail, newEmail string) error
